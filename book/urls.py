...
urlpatterns = [
    ...
    path(
        "start-reading-session/<int:book_id>/",
        StartReadingSession.as_view(),
        name="start-reading-session",
    ),
    path(
        "end-reading-session/<int:book_id>/",
        EndReadingSession.as_view(),
        name="end-reading-session",
    ),
    path(
        "total-reading-time/<int:book_id>/",
        TotalReadingTime.as_view(),
